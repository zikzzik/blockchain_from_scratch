...
class Blockchain:
    ...
    def add_block(self, block, lock):
        """Method use to add a block in the blockchain
    ...
    def get_last_block_idx(self):
        """ Method use to get the index of the last block in the blockchain
    ...
    def create_genesis_block(self):
        """ Method use to create the genesis block
        ...
        genesis_bloc.add_transaction(Transaction("SYSTEM", "FiLz2wYz1kXuisZg1koWDhZhrekhD7GSgNLRevXH5b5U", 5000, ts))
    ...
    def is_valid_blockchain(self, difficulty: int):
        """ Method use to check if the blockchain is valid
